...
module.exports = function(app) {
  ...
  router.post('/api/back/resource/uploader', powerAdmin, controller.api.back.resource.uploader); //标准后台资源上传
  router.post('/api/back/resource/wangeditor/uploader', powerAdmin, controller.api.back.resource.wangeditorUploader); //wangeditor后台资源上传
