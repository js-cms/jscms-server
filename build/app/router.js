...
module.exports = app => {
    ...
    router.get('/s', controller.home.search); // 搜索页面
    router.get('/', controller.home.index); //首页
    router.get('/:routerName', controller.home.index); //伪静态入口
    router.get('/tags/:tagName', controller.home.tags); //通过标签/关键字查找文章列表
    router.get('/author/:nickname', controller.home.author); // 用户页面
    router.get('/page/:pageAlias', controller.home.page); // 页面路由
    router.get('/s/:keyword', controller.home.search); // 搜索页面
